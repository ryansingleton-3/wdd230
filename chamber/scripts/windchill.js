...
async function getWeather() {
  resp = await fetch("http://api.weatherapi.com/v1/current.json?key=8184f1e17133404b88c32358231002&q=62960&aqi=no")
...
function getWeatherSpecs(data) {
  ...
  if (temp <=50 && windMPH > 3) {
    windChill = 35.74 + (0.6215 * temp) - (35.75 * (windMPH ** 0.16)) + ((0.4275)(temp)(windMPH ** 0.16))
  } else {
    windChill = "N/A"
  }
